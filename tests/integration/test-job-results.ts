...
describe('Dataproc Job Results Integration Tests', () => {
  ...
  it('should successfully submit a Hive query and retrieve results', async function() {
  ...
  it('should handle invalid job IDs gracefully', async function() {
    try {
  ...
  it('should handle missing driverOutputResourceUri gracefully', async function() {
